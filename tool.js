	...
	},
	{
		...
		schema: z.object({
			info: z
				.string()
				.describe(
					"Вся информация о моем заказе, которую ты получила в ходе разговора"
				),
			cost: z
				.string()
				.describe(
					"Информация о стоимости каждого блюда из моего заказа. формат ответа: название блюда - стоимость этого блюда(число)"
				),
		}),
	}
);
